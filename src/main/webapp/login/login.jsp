							...
							<form id="login">
								...
								<div class="form-group">
									<input type="password" class="form-control" name="password"
										id="password" required="required" placeholder="密码">
								</div>
							...
							<form id="register">
								...
								<div class="form-group">
									<input type="email" class="form-control" name="email"
										id="email" required="required" placeholder="邮箱">
								</div>
								<p style="font-size: 10px">
									...
									.ajax({
										...
										success : function(data) {
											if (data.trim() == "OK")//要加上去空格，防止内容里面有空格引起错误。
											{
												...
												/* 显示提示信息 */
												document
														.getElementById("loginSuccess").innerHTML = str;
												setTimeout(go, 500);//0.5秒后页面跳转
											} else {
												var str = "用户名或密码错误！";
												/* 显示提示信息 */
												document
														.getElementById("loginExit").innerHTML = str;
											}
										}
									});
									...
									.ajax({
										...
										success : function(data) {
											if (data.trim() == "OK")//要加上去空格，防止内容里面有空格引起错误。
											{
												...
												/* 显示提示信息 */
												document
														.getElementById("registerSuccess").innerHTML = str;
												setTimeout(go, 500);//0.5秒后页面跳转
											} else if (data.trim() == "PASS") {
												var str = "两次输入的密码不一致！";
												/* 显示提示信息 */
												document
														.getElementById("confirmPassExit").innerHTML = str;
												/* 清空指定输入框 */
												document
												...
												/* 显示提示信息 */
												document
														.getElementById("registerName").innerHTML = str;
											}
										}
									});
