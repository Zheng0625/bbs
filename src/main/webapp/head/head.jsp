...
<link href="${APP_PATH}/static/layui/layui/css/layui.css"
	rel="stylesheet">
</head>
<body>
	<!--导航条（头）-->
		...
		<div class="row">
			<div class="col-md-10 col-md-offset-1">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="${APP_PATH}/index.jsp"> <img
						class="img_logo" alt="Brand"
						src="${APP_PATH}/static/img/logo-lanse.png">
					</a>
				</div>
				...
				<div class="collapse navbar-collapse"
					...
					<ul class="nav navbar-nav">
						<li class="active"><a href="${APP_PATH}/index.jsp">首页 <span
								class="sr-only">(current)</span></a></li>
					</ul>


					<form class="navbar-form navbar-left"
						action="${APP_PATH }/common/getArticleTitle" method="post">
						<div class="row">
							<div class="col-xs-9 col-md-8">
								<input type="text" name="articleTitle" class="form-control"
									placeholder="输入收索内容..." required>
							</div>
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<c:if test="${!empty username}">
							<li><a href="Javascript:void(0)" data-toggle="modal"
								data-target="#faTie" onclick="postedShow()">发帖</a></li>
							<!-- pc -->
							<li class="dropdown"><a href="#" class="dropdown-toggle"
								...
								<ul class="dropdown-menu">
									<li>
										<div class="row">
											<div class="col-xs-3 col-md-6 myself_img">
												<a href="#" onclick="skipMycontent()"> <img
													class="img_right_logo"
									...
									<li>
										<div class="row">
											<div class="col-xs-3 col-md-6 myself_img">
												<a href="#" data-toggle="modal" data-target="#setup"> <img
													class="img_right_logo"
									...
									<li>
										<div class="row">
											<div class="col-xs-3 col-md-6 myself_img">
												<a href="${APP_PATH}/userController/userExit"> <img
													class="img_right_logo"
	...
	<script src="${APP_PATH}/static/layui/layui/layui.js"></script>
