                    ...
                    success: function (data) {
                        ...
                        for (var j = 0; j < commentCount; j++){
                            ...
                            comment_traversals = comment_traversals +
                                '<a class="" href=' + APP_PATH + '/userController/getOthers?userid='+comment["userid"]+'>' +
                                '<!-- 评论者姓名 -->' +
                                '<b>'+comment["name"]+'</b>' +
                                '</a>' +
                                '&nbsp;&nbsp;&nbsp;' +
                            ...
                            myself_article_comment = myself_article_comment +
                                ...
                                '<div class="row" style="position: relative; margin-top: -10px;">' +
                                    '<div class="col-xs-9 col-md-11">' +
                                        '<a href="'+ APP_PATH +'/userController/getOthers?userid='+comment["userid"]+'" class="">' +
                                        '<!-- 评论者姓名 -->' +
                                        '<b>'+comment["name"]+'</b>' +
                                        '</a>' +
                                        '&nbsp;&nbsp;&nbsp;' +
                    ...
                    success: function (data) {
                        ...
                        for (var j =0 ;j<huifu_comments.length;j++){
                            ...
                            huifu_comment_all = huifu_comment_all +
                                ...
                                '<a href="'+APP_PATH+'/userController/getOthers?userid='+huifu_comment["userid"]+'" class="">' +
                                '<!-- 评论者姓名 -->' +
